  ...
  try {
    ...
    if (itemType === "salad") {
      ...
      return res.json({
        ...
        category: match.category,
        base_price: parseFloat(match.price_default || 0),
        unit_price: parseFloat(match.price_default || 0) + (saladMods[0] ? saladMods[0].price : 0),
        modifiers: saladMods,
        special_instructions: specialInstructions || undefined
      });
    }
    ...
    // ── GENERIC LOOKUP (sides, desserts, pasta, stromboli, quesadilla, clubs, nuggets, seafood, platters) ──
