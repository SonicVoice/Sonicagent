    ...
    if (appliedDiscounts.length === 0) {
      ...
      for (var si = 0; si < items.length; si++) {
        ...
        for (var qq = 0; qq < qty; qq++) {
          ...
          // Subs
          else if (nm.indexOf("sub") !== -1 && !nm.indexOf("12") !== -1 && (parseFloat(it.unit_price||0) < 10)) subs8.push(si);
          else if (nm.indexOf("sub") !== -1 && nm.indexOf("12") !== -1) subs12.push(si);
          else if (nm.indexOf("sub") !== -1 && parseFloat(it.unit_price||0) >= 10) subs12.push(si);
          // Wings
