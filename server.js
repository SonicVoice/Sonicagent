...
app.get("/test-order", async function (req, res) {
  ...
  var result = await sendToPOS(built.xml);
  res.json({ version: "V12", xml: built.xml, pos: result, ref: built.ref });
});
...
app.get("/", function (req, res) {
  res.json({ status: "running", version: "V12", restaurant_id: CONFIG.RESTAURANT_ID,
...
app.listen(CONFIG.PORT, function () { console.log("V12 POS Bridge | Port: " + CONFIG.PORT + " | ID: " + CONFIG.RESTAURANT_ID); });
